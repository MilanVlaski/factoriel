...
public class TestOutput {
	...
	assertThat(Output.solveFactorial(-5))
		.isEqualTo("-5 is not a positive integer.");
	assertThat(Output.solveFactorial(-2))
		.isEqualTo("-2 is not a positive integer.");
    }
	...
	assertThat(Output.accept("five")).isEqualTo("Input invalid.");
    }

    @Test
    void prints_alert_that_input_is_invalid_if_special_characters_used() {
	assertThat(Output.accept(";")).isEqualTo("Input invalid.");
    }
}
